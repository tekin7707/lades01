...
/* harmony import */ var app_guards_auth_guard__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! app/guards/auth.guard */ "./src/app/guards/auth.guard.ts");
...
var AdminLayoutRoutes = [
    ...
    //     }]
    // }
    { path: 'dashboard', component: _dashboard_dashboard_component__WEBPACK_IMPORTED_MODULE_0__["DashboardComponent"], canActivate: [app_guards_auth_guard__WEBPACK_IMPORTED_MODULE_8__["AuthGuard"]] },
    { path: 'user-profile', component: _user_profile_user_profile_component__WEBPACK_IMPORTED_MODULE_1__["UserProfileComponent"], canActivate: [app_guards_auth_guard__WEBPACK_IMPORTED_MODULE_8__["AuthGuard"]] },
...
var UserProfileComponent = /** @class */ (function () {
    function UserProfileComponent(router, authService) {
        this.router = router;
    ...
    UserProfileComponent.prototype.showNotification = function (type, message) {
        $.notify({
            icon: "notifications",
            message: message
        }, {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        this.loading = true;
                        return [4 /*yield*/, this.authService.update(this.user)];
                    case 1:
                        r = _a.sent();
                        this.loading = false;
                        if (r.status == 200) {
    ...
    UserProfileComponent.prototype.getUserList = function () {
        return __awaiter(this, void 0, void 0, function () {
            var a;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.authService.getUserList(1)];
                    case 1:
                        a = _a.sent();
                        console.log(a);
                        return [2 /*return*/];
