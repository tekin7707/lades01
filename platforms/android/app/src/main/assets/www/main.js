...
module.exports = "<div>\n    <div class=\"container\">\n        <br>\n        <div class=\"row\">\n            <div class=\"col-lg-2 col-md-2 col-sm-1\">\n            </div>\n            <div class=\"col-lg-8 col-md-8 sol-sm-10\">\n                <div class=\"card text-center\">\n                    <div class=\"card-header card-header-danger\">\n                        <h4 class=\"card-title\">Register</h4>\n                        <p class=\"card-category\">register page</p>\n                    </div>\n                    <div class=\"card-body text-center\">\n                        <form #registerForm=\"ngForm\">\n\n                            <div class=\"row\" *ngIf=\"registerError!=''\">\n                                <div class=\"col-md-12\">\n                                    <p class=\"info-red\" style=\"font-size: large\">* {{registerError}}</p>\n                                </div>\n                            </div>\n\n                            <div class=\"row\">\n                                <div class=\"col-md-12\">\n                                    <mat-form-field >\n                                        <input  name=\"email\" required [(ngModel)]=\"email\" matInput placeholder=\"Email address\" type=\"email\">\n                                    </mat-form-field>\n                                    <mat-error *ngIf=\"emailError!=''\">{{emailError}}</mat-error>\n                                </div>\n                            </div>\n                            <div class=\"row\">\n                                <div class=\"col-md-6\">\n                                    <mat-form-field >\n                                        <input name=\"password1\" [(ngModel)]=\"password1\" matInput placeholder=\"Password\" type=\"password\">\n                                    </mat-form-field>\n                                    <mat-error *ngIf=\"password1Error!=''\">{{password1Error}}</mat-error>\n                                </div>\n                                <div class=\"col-md-6\">\n                                    <mat-form-field >\n                                        <input name=\"password2\" [(ngModel)]=\"password2\" matInput placeholder=\"Password *\" type=\"password\">\n                                    </mat-form-field>\n                                    <mat-error *ngIf=\"password2Error!=''\">{{password2Error}}</mat-error>\n                                </div>\n                            </div>\n                            <button mat-raised-button type=\"submit\" class=\"btn btn-danger pull-center\"\n                            (click)=\"register()\">Register</button>\n                            <div class=\"clearfix\"></div>\n                        </form>\n                    </div>\n                </div>\n            </div>\n        </div>\n    </div>\n</div>"
...
var RegisterComponent = /** @class */ (function () {
    ...
    RegisterComponent.prototype.showNotification = function (type, message) {
        $.notify({
            icon: "notifications",
            message: message
        }, {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        this.password1Error = '';
                        this.password2Error = '';
                        _e = this.authService.emailCheck(this.email);
                        _p = this.authService.passwordCheck(this.password1);
                        if (_e != this.email) {
                            this.emailError = _e;
                        ...
                        if (!(this.registerError == '')) return [3 /*break*/, 2];
                        user = { email: this.email, password: this.password1 };
...
var NavbarComponent = /** @class */ (function () {
    function NavbarComponent(authSerivce, location, element, router) {
        this.authSerivce = authSerivce;
        this.element = element;
        this.router = router;
        this.mobile_menu_visible = 0;
        // authSerivce.logout();
        this.user = authSerivce.getLoginUser();
        console.log('%c %s', 'background-color:orange', this.user ? this.user.email : 'nope');
        this.location = location;
...
var SidebarComponent = /** @class */ (function () {
    function SidebarComponent(authSerivce, router) {
        this.authSerivce = authSerivce;
        this.router = router;
        this.user = authSerivce.getLoginUser();
    }
    ...
    SidebarComponent = __decorate([
        ...
        __metadata("design:paramtypes", [app_services_auth_service__WEBPACK_IMPORTED_MODULE_1__["AuthService"],
...
var AuthGuard = /** @class */ (function () {
    ...
    AuthGuard.prototype.canActivate = function (next, state) {
        var _login = this.authService.getLoginUser();
        if (_login) {
            console.log(_login);
    ...
    AuthGuard = __decorate([
        ...
        __metadata("design:paramtypes", [app_services_auth_service__WEBPACK_IMPORTED_MODULE_2__["AuthService"],
...
var AuthService = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.httpClient.post(url, { email: u, password: p }, { headers: headers }).toPromise()
                                .then(function (d) {
                                console.log(d);
                                r = d;
                                console.log(r.data);
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]().set('Content-Type', 'application/json');
                        // .set('Authorization', 'Basic ' + btoa(username + ':' + password));
                        return [4 /*yield*/, this.httpClient.post(url, u, { headers: headers }).toPromise()
                                .then(function (d) {
                                console.log(d);
                                r = d;
                                console.log(r.data);
    ...
    AuthService.prototype.update = function (u) {
        return __awaiter(this, void 0, void 0, function () {
            var r, url, headers;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    AuthService.prototype.getUserList = function (cid) {
        return __awaiter(this, void 0, void 0, function () {
            var r;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        r = { status: 200, message: '' };
                        return [4 /*yield*/, this.httpClient.get(this.base_url + '/getAll').toPromise()
                                .then(function (d) {
                                r.data = d;
                                console.log(d);
                            })
    ...
    AuthService.prototype.updateStrogeAuth = function (_user) {
        var temp = localStorage.getItem('ladesAuth');
        if (temp) {
            var userStroge = JSON.parse(localStorage.getItem('ladesAuth')); // as User;
    ...
    AuthService.prototype.emailCheck = function (em) {
        var isValid = /^[_a-z0-9]+(\.[_a-z0-9]+)*@[a-z0-9-]+(\.[a-z0-9-]+)*(\.[a-z]{2,4})$/.test(em.toLowerCase());
        if (isValid)
            return em;
        else
            return 'Please enter a valid e-mail address';
    };
    AuthService.prototype.passwordCheck = function (password) {
        var r = '';
        if (password.length < 1)
            r = 'Password does not meet the minimum requirements';
        return r;
    };
...
module.exports = __webpack_require__(/*! C:\works\tekin\lades01\src\main.ts */"./src/main.ts");
